...
@CommandMetaData(name = "fsck",
    description = "Check specific projects or changes")
final class FsckCommand extends SshCommand {
  @Option(name = "--all", usage = "check all known projects")
  private boolean all;

  @Option(name = "--fix",
      usage = "attempt fixing errors, may remove missing changes from DB")
  private boolean fix;
  ...
  @Inject
  public FsckCommand(ProjectCache projectCache, Changes changes,
      GerritApi api) {
