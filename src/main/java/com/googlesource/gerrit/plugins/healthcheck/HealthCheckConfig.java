...
public class HealthCheckConfig {
  ...
  private static final int MIN_CHANGE_ID = 1;
  ...
  @VisibleForTesting
  void unsetSection(final String section, final String subsection) {
    config.unsetSection(section, subsection);
  }
  ...
  public Change.Id getIndexWritableChangeId() throws ConfigInvalidException {
    int defaultChangeId = MIN_CHANGE_ID - 1;
    int changeId =
