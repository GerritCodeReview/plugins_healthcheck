...
public class HealthCheckConfig {
    ...
    public long getTimeout(String healthCheckName) {
        ...
        return config.getTimeUnit(HEALTHCHECK, healthCheckName, "timeout", defaultTimeout, TimeUnit.MILLISECONDS);
    }

    public String getQuery(String healthCheckName) {
        String defaultQuery = healthCheckName == null ? QUERY_DEFAULT : getQuery(null);
        return MoreObjects.firstNonNull(config.getString(HEALTHCHECK, healthCheckName, "query"), defaultQuery);
    }
