...
public class HealthCheckConfig {
  ...
  private static final int THRESHOLD_DEFAULT = 80;
  ...
  public int getThreshold(String healthCheckName) {
    int defaultThreshold = healthCheckName == null ? THRESHOLD_DEFAULT : getThreshold(null);
