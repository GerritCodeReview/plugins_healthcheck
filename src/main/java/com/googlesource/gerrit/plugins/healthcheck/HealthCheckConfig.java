...
public class HealthCheckConfig {
  ...
  private static final Set<String> HEALTH_CHECK_DISABLED_FOR_SLAVES = Collections.singleton(QUERYCHANGES);
  ...
  public boolean healthCheckEnabled(String healthCheckName) {
    if(isSlave && HEALTH_CHECK_DISABLED_FOR_SLAVES.contains(healthCheckName)) {
      return false;
    }
