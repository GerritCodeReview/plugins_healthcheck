...
public class HealthCheckConfig {
  ...
  private static final String FAILED_FILE_FLAG_DEFAULT = "data/healthcheck/fail";
  ...
  public String getFailedFileFlagPath() {
    return getStringWithFallback("failedFileFlagPath", null, FAILED_FILE_FLAG_DEFAULT);
  }
