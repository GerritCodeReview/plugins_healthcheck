...
public class HealthCheckConfig {
  ...
  private static final ImmutableList<String> checksDisabledByDefault = ImmutableList.of(GITSPACE);
  ...
  public boolean healthCheckEnabled(String healthCheckName) {
    ...
    boolean defaultValue =
        checksDisabledByDefault.stream().noneMatch(hc -> hc.equals(notNullHealthcheckName));
