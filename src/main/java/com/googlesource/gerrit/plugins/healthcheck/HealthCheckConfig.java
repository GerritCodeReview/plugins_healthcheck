...
public class HealthCheckConfig {
  ...
  private boolean getBooleanWithFallback(
      String parameter, String healthCheckName, boolean defaultValue) {
    boolean fallbackDefault =
        healthCheckName == null
            ? defaultValue
            : getBooleanWithFallback(parameter, null, defaultValue);
    return MoreObjects.firstNonNull(
        config.getBoolean(HEALTHCHECK, healthCheckName, parameter, fallbackDefault),
        fallbackDefault);
  }
