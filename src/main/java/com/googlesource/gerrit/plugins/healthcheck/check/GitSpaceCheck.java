...
import static com.googlesource.gerrit.plugins.healthcheck.check.HealthCheckNames.GIT_DIR_SPACE;
...
public class GitSpaceCheck extends AbstractHealthCheck {
  ...
  public GitSpaceCheck(
    ...
    super(executor, config, GIT_DIR_SPACE, metricMaker);
  ...
  protected Result doCheck() throws Exception {
    int minDiskFreePercent = config.getMinDiskFreePercent(GIT_DIR_SPACE);
