...
public class AbstractHealthCheckTest {
  ...
  public void shouldPublishAllMetricsWhenFailing() {
    ...
    assertThat(testMetricMaker.getFailureCount()).isEqualTo(1L);
    assertThat(testMetricMaker.getLatency()).isEqualTo(100L);
  }
  ...
  private static class DummyHealthCheckMetricsFactory implements HealthCheckMetricsFactory {
