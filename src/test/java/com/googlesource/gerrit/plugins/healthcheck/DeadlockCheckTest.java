...
public class DeadlockCheckTest {
  ...
  public void shouldFailCheckWhenSingleDeadlock() {
    ...
    MetricRegistry metricRegistry = createMetricRegistry(1);
  ...
  public void shouldFailCheckWhenMultipleDeadlocks() {
    ...
    MetricRegistry metricRegistry = createMetricRegistry(5);
  ...
  private DeadlockCheck createCheck(Injector injector, HealthCheckConfig healtchCheckConfig) {
