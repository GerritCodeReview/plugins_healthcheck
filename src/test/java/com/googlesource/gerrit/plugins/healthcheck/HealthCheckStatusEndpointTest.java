...
public class HealthCheckStatusEndpointTest {
  ...
  public static class TestHealthCheck implements HealthCheck {
    ...
    public TestHealthCheck(String checkName, boolean result, long ts, long elapsed) {
      this.checkName = checkName;
      this.checkResult = new Result(result, ts, elapsed);
    }
            ...
            new AbstractModule() {
              ...
              protected void configure() {
                DynamicSet.bind(binder(), HealthCheck.class)
                    .toInstance(new TestHealthCheck("checkOk", true, 1, 2));
              }
            });
            ...
            new AbstractModule() {
              ...
              protected void configure() {
                DynamicSet.bind(binder(), HealthCheck.class)
                    .toInstance(new TestHealthCheck("checkOk", true, 1, 2));
                DynamicSet.bind(binder(), HealthCheck.class)
                    .toInstance(new TestHealthCheck("checkKo", false, 1, 2));
              }
            });
