...
public class HealthCheckStatusEndpointTest {
  ...
  public static class TestHealthCheck extends AbstractHealthCheck {
    ...
    public TestHealthCheck(
        HealthCheckConfig config, String checkName, HealthCheck.Result result, long sleep, HealthCheckMetricsFactory healthCheckMetricsFactory) {
      super(MoreExecutors.listeningDecorator(Executors.newFixedThreadPool(10)), config, checkName, healthCheckMetricsFactory);
        ...
        testInjector(
            new AbstractModule() {
              ...
              protected void configure() {
                ...
                DynamicSet.bind(binder(), HealthCheck.class)
                    .toInstance(
                        new TestHealthCheck(config, "checkOk", HealthCheck.Result.PASSED, 30, healthCheckMetricsFactory));
