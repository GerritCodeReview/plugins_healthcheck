...
public class JGitHealthCheckTest {
  ...
  public void shouldBeHealthyWhenJGitIsWorking() {
    JGitHealthCheck reviewDbCheck =
        new JGitHealthCheck(executor, getWorkingRepositoryManager(), allProjectsName, new DisabledMetricMaker());
  ...
  public void shouldBeUnhealthyWhenJGitIsFailing() {
    JGitHealthCheck jGitHealthCheck =
        new JGitHealthCheck(executor, getFailingGitRepositoryManager(), allProjectsName, new DisabledMetricMaker());
